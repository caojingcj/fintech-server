...
public class AlipaySmsDaYu {
    ...
    */
    public static SendSmsResponse sendSms(String mobile,String tempCode,String code,String tempContent) throws ClientException {
        ...
        request.setTemplateParam(tempContent);
...
//        request.setOutId("123123");
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        if(response.getCode() != null && response.getCode().equals("OK")) {
            QuerySendDetailsResponse querySendDetailsResponse = querySendDetails(response.getBizId(),"13813948485");
