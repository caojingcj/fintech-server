...
/**   
* @Title: ShortUrlTest.java 
* @Package com.fintech.util 
* @author qierkang xyqierkang@163.com   
* @date 2018年7月15日 下午7:00:48  
* @Description: TODO[ 用一句话描述该文件做什么 ]
*/
public class ShortUrlTest {
    public static void main(String[] args) {
        String sLongUrl = "http://om.51datakey.com/trail/magicwand?customerId=2577&secret=b61409b296e142f89837b4e61879675e"; // 原始链接
